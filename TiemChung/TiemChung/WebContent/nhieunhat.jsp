...
<body>
				...
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav">
						...
						<li class=""><a href="KhachHangServlet">Quản lý khách
								hàng</a></li>
						<li class=""><a href="QuanLyTiemChungServlet">Quản lý
								tiêm chủng</a></li>
	...
	<tr>
		<td colspan="9"><h2 align="center">
				<span style="color: black">Danh Sách Vacxin đã sử dụng nhiều
					nhất, ít nhất </span>
			</h2></td>
	...
	<center>
		...
		<ul class="pagination">
			<li><a
				href="nhieunhatSV?page=1<%= request.getParameter("s") !=null?"&s="+request.getParameter("s"):"" %>">
					<< </a></li>
			<%
			...
			<li class="<%= curent_page == (i + 1)?"active":"" %>"><a
				href="nhieunhatSV?page=<%=i+1 %><%= request.getParameter("s") !=null?"&s="+request.getParameter("s"):"" %>"><%= i + 1 %></a></li>
