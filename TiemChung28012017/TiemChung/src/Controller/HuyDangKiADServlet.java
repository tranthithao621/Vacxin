...
/**
 * Servlet implementation class HuyDangKiADServlet
 */
@WebServlet("/HuyDangKiADServlet")
public class HuyDangKiADServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HuyDangKiADServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  		...
  		try {
  			...
  			RequestDispatcher rd = request.getRequestDispatcher("LichDatTiemServlet");
